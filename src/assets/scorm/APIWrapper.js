 ...
 * export function which will be implemented by the LMS.
 *
 * @export function doLMSInitialize
...
export function doLMSFinish() {
  ...
  if (api == null) {
    ...
    // call the LMSFinish export function that should be implemented by the API
 ...
 *******************************************************************************/
export function doLMSGetValue(name) {
  var api = getAPIHandle();
  if (api == null) {
    alert(
 ...
 * @description Wraps the call to the LMS LMSSetValue export function.
 *******************************************************************************/
export function doLMSSetValue(name, value) {
  var api = getAPIHandle();
  if (api == null) {
    alert(
...
/*******************************************************************************
 * Call the LMSGetLastError export function
 *
 * @param {None} Inputs: None
 * @return {string} The error code that was set by the last LMS export function call
 *******************************************************************************/
export function doLMSGetLastError() {
  var api = getAPIHandle();
  if (api == null) {
    alert(
 ...
 *******************************************************************************/
export function doLMSGetErrorString(errorCode) {
  var api = getAPIHandle();
  if (api == null) {
    alert(
...
/*******************************************************************************
 * Call the LMSGetDiagnostic export function
 *
 ...
 *******************************************************************************/
export function doLMSGetDiagnostic(errorCode) {
  var api = getAPIHandle();
  if (api == null) {
    alert(
 ...
 *******************************************************************************/
export function LMSIsInitialized() {
  // there is no direct method for determining if the LMS API is initialized
  // for example an LMSIsInitialized export function defined on the API so we'll try
...
/*******************************************************************************
 * This export function looks for an object named API, first in the current window's
